...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex">
      {/* Left panel — branding */}
      <div className="hidden lg:flex flex-col justify-center w-1/2 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 p-16 border-r border-white/5 gap-8">
        ...
        <h1
          className="animate-fade-up stagger-3 text-5xl leading-tight text-white mb-6 font-extrabold"
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          {/* Mobile logo */}
          <div className="lg:hidden flex items-center gap-3 mb-12 animate-fade-up stagger-1">
            <a
              href="/"
              aria-label="Durianpay"
              className="inline-block w-[148px] h-8"
          ...
          <div className="animate-fade-up stagger-2 mb-10">
            <h2
          ...
          <div className="space-y-4">
            <div className="animate-fade-up stagger-3">
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-white placeholder-slate-600 text-sm focus:outline-none focus:border-orange-500 transition-all"
              />
            </div>
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="w-full bg-orange-500 hover:bg-orange-600 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold rounded-xl py-3 px-6 text-sm transition-all duration-200 flex items-center justify-center gap-2 mt-2"
              style={{ fontFamily: 'Syne,sans-serif' }}
            >
              {loading ? (
                <>
